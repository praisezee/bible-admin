...
export default function ChaptersPage() {
  ...
  const fetchData = async () => {
    try {
      setIsLoading(true)
      const [chaptersResponse, booksResponse] = await Promise.all([apiClient.getChapters(), apiClient.getBooks()])
    ...
    <DashboardLayout>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all chapters organized by book. You can create, edit, and delete chapters.
          </CardDescription>
        </CardHeader>
        <CardContent>
