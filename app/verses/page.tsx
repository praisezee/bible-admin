    ...
    try {
      ...
      if (versesResponse.success && versesResponse.data) {
        ...
        const enrichedVerses = versesResponse.data.map((verse: any) => {
          const chapter = chaptersResponse.data?.find((c: any) => c.id === verse.chapterId)
    ...
    <DashboardLayout>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage individual verses within chapters</p>
        </div>
                    ...
                    return (
                      <TableRow key={verse.id}>
                        ...
                        <TableCell className="max-w-md">
                          <p className="text-sm leading-relaxed">{truncateText(verse.text, 150)}</p>
                        </TableCell>
                        <TableCell>
                          {book && (
                            <Badge
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem onClick={() => handleDeleteVerse(verse)} className="text-destructive">
