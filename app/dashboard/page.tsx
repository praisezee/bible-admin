...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const [booksResponse, chaptersResponse, versesResponse, lastUpdatedResponse] = await Promise.all([
          apiClient.getBooks(),
    ...
    <DashboardLayout>
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Verses across all chapters</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:gap-8 lg:grid-cols-2 xl:grid-cols-3">
        <Card className="xl:col-span-2">
          <CardHeader>
            <CardTitle>Welcome to Bible Admin Dashboard</CardTitle>
            <CardDescription>Manage your Bible content with ease</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Use this dashboard to manage books, chapters, and verses in your Bible database. You can create, edit, and
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <ul className="text-sm space-y-1">
              ...
              <li>• Export Complete Bible Data</li>
            </ul>
          </CardContent>
        </Card>
      </div>
